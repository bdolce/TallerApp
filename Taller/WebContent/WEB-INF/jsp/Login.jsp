...
<body>
    <form class="form-signin" method="post" action="LoginServlet" >
      ...
      <p class="mt-5 mb-3 text-muted">¿No está registrado? <a href="#">Crear una cuenta</a></p>
    </form>
    <form class="form-signin" method="post" action="LoginServlet" >
      <img class="mb-4" src="https://getbootstrap.com/docs/4.0/assets/brand/bootstrap-solid.svg" alt="" width="72" height="72">
      ...
      <p class="mt-5 mb-3 text-muted">¿Ya tiene una cuenta? <a href="#">Ingresar al sistema</a></p>
    </form>
</body>
</html>
...
<t:layout>
  ...
  <jsp:body>
    ...
    <div id="nuevoTipo" class="modal fade">
      <div class="modal-dialog">
        <div class="modal-content">
          <form id="formNuevo" method="post" action="Tipos">
            ...
            <div class="modal-body">   
              ...
              <div class="form-group">
                ...
                <input type="text" id="modal-nombre" class="form-control" name="tip-descripcion" required>
              </div>     
            </div>
    ...
    <!-- Edit Modal HTML -->
    <div id="editarTipo" class="modal fade">
      <div class="modal-dialog">
        <div class="modal-content">
          <form id="formEditar" method="post" action="Tipos">
            <div class="modal-header">            
            ...
            <div class="modal-body">  
              ...
              <div class="form-group">
                <label>ID</label>
                <input type="text" id="modal-id" class="form-control" name="tip-id" readonly required>
              </div>        
              <div class="form-group">
                <label>Descripcion</label>
                <input type="text" id="modal-descripcion" class="form-control" name="tip-descripcion" required>
              </div>
            </div>
            <div class="modal-footer">
